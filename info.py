...
# Bot information
API_ID = environ.get('API_ID', '20475714')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'a3d6d3f2a3d9677d3a581f7364989f4c') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6021953357 6914575809') #apni tg id daalo
if len(ADMINS) == 0:
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002160289876') #support group id ex:  -1002936246860
...
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/unique_hacker_2006')
